    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href=<?= base_url('lihatbarang')?>>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item">
                  <a class="nav-link" href=<?= base_url('transaksi')?>>Transaksi</a>s
                </li>
                <li class="nav-item">
                  <a class="nav-link" href=<?= base_url('detailtransaksi')?>>Detail Transaksi</a>
                </li>
              </ul>
            </div>
          </li>
